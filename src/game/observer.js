...
export class Observer {
   ...
   *   remembered  아무도 안 시켰는데 **흘린 말을 기억해서** (for: 그 사람)
   *
   * `errand`와 `remembered`가 같은 줄로 가면 안 된다. 시켜서 한 것은
   * *누구 말을 들어줬나*이고, 기억해서 한 것은 *누구 말을 듣고 있었나*다 —
   * 후자가 이 게임이 재려는 것에 훨씬 가깝다 (game/wants.js).
   */
